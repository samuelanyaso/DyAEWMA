...
##' @examples
##' ats_arl_aewma_max(0.025,50,100,1000,0,2.5,3.1,0.05)
ats_arl_aewma_max <- function(alpha, w = 50, nsimul, repl = 1e+06, a, lambda, b, shift = 0) {
    res <- arl_ats_max(alpha, w, nsimul, repl, a, lambda, b, shift)
